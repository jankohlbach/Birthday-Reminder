...
export default function Imprint() {
  return (
    <div className="privacy">
      ...
      <p>
        <span>Telephone: </span>
        <a href="tel:+4917643675791">+49 176 43675791</a>
        <br />
        <span>E-Mail: </span>
        <a href="mailto:contact@b-reminded.com">contact@b-reminded.com</a>
        <br />
        <span>Web: </span>
        <a href="https://jankohlbach.com">jankohlbach.com</a>
      </p>
      ...
      <ul>
        ...
        <li>
          ...
          them is being processed by the controller in breach of data protection provisions
          (see also Art. 77 GDPR).
        </li>
      </ul>
      <p>
        In addition, the controller is obliged to inform all recipients to whom it discloses data
        of any such corrections, deletions, or restrictions placed on processing the same per
        Art. 16, 17 Para. 1, 18 GDPR. However, this obligation does not apply if such notification
        is impossible or involves a disproportionate effort. Nevertheless, users have a right to
      ...
      <p>
        ...
        purpose for its storage ceases to apply, provided the deletion of the same is not in breach
        of any statutory storage obligations or unless otherwise stipulated below.
      </p>
      <h4>Server data</h4>
      <p>
      ...
      <p>
        The data thus collected will be temporarily stored, but not in association with any other
        of your data.
      </p>
      <p>
